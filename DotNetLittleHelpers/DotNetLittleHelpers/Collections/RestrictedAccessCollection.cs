...
namespace DotNetLittleHelpers.Collections
{
    using System.Collections.ObjectModel;

    /// <summary>
    /// This collection restricts the access to collection manipulators (Add, Clear, Insert, Remove, RemoveAt) by marking them as Obsolete <para/>
    /// Unilike .NET built-in ReadOnlyCollection, this allows being used as collection entity in Entity Framework,
    /// and controlling the collection modification via the Domain Model class which uses it. <para/>
